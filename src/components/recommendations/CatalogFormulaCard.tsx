...
export default function CatalogFormulaCard({
  ...
  return (
    ...
    >
      ...
      <div className={`min-h-0 flex flex-col flex-1 ${isComparison ? "p-3 sm:p-4" : "p-2 sm:p-3"}`}>
        <div className={`shrink-0 ${isComparison ? "mb-3 pb-2.5 border-b border-primary/10" : "mb-1 sm:mb-2"}`}>
          {isComparison && (
