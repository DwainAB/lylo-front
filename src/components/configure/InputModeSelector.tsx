      ...
      <div className="grid grid-cols-3 gap-2.5">
        {options.map((option) => (
          <label key={option.value} className="group relative cursor-pointer">
            ...
            />
            <div className="flex items-center justify-center px-2 py-2 [@media(max-height:620px)]:py-1.5 rounded-lg border-2 border-primary/10 brand-surface-soft text-primary/60 transition-all group-hover:bg-primary/5 peer-checked:border-primary peer-checked:bg-primary peer-checked:text-white peer-checked:shadow-lg">
