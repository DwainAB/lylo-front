...
export default function ModeSelector({ value, onChange }: ModeSelectorProps) {
  ...
  return (
    <section className="relative">
      ...
      {/* Tooltip */}
      {showInfo && (
        <div className="absolute z-20 top-6 right-0 w-60 bg-white border border-primary/15 rounded-lg shadow-lg p-3 text-[11px] text-primary/80 leading-relaxed space-y-2">
